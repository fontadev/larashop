                    ...
                    <form action="{{ route('products.update', $product) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number"
                                ...
                                id="stock_quantity"
                                name="stock_quantity"
                                value="{{ old('stock_quantity', $product->mainStock ? $product->mainStock->quantity : 0) }}"
                                min="0"
                                required>
                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <input type="number"
                                                    ...
                                                    min="0"
                                                    value="{{ $variation->stock ? $variation->stock->quantity : 0 }}"
                                                    required>
                                            </div>
                        ...
                        <button type="submit"
                            class="btn btn-primary">Atualizar Produto</button>
                    </form>
                </div>
            </div>
        </div>
...
@section('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            let variationIndex = {{ $product->variations->count() > 0 ? $product->variations->count() - 1 : 0 }};
